...
public class FollowerConstants {
    ...
    private static double xMovement = 107.88254;
    private static double yMovement = 71.89656;
    ...
    public static double forwardZeroPowerAcceleration = -53.4782;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -80.54015;
