...
public class SpecAuto extends OpMode {
    ...
    private final Pose push1 = new Pose(32, 22, toRadians(0));
    ...
    private final Pose push2= new Pose(32, 12, toRadians(0));
    ...
    private final Pose grab1= new Pose(12.8,1.7, toRadians(0));
    ...
    private final Pose place4 = new Pose(46.6, 64, toRadians(0));

    private final Pose parkPose = new Pose(7, 24, toRadians(-90));
    ...
    public void buildPaths() {
        ...
        park = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, () -> intakeTeleOp())
                .addParametricCallback(0.1, () -> outtakeTeleOp())
                .build();
