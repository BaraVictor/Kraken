...
public class ServoConstants {
    ...
    public static final double OUTTAKE_CLAW_CLOSED_POSITION = 0.90;
    ...
    public static final double INTAKE_ELBOW_LEFT_RETRACTED_POSITION = 0.5354;
    public static final double INTAKE_ELBOW_RIGHT_EXTENDED_POSITION = 0.5354;
