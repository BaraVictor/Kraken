...
public class Sample extends OpMode {
    ...
    private final Pose subLeft = new Pose(64, 96, Math.toRadians(-90));

    private final Pose subRight = new Pose(62, 96, Math.toRadians(-90));


    private final Pose sub2 = new Pose(sub2X, 91, Math.toRadians(-90));

    private final Pose sub2Left = new Pose(67,96,Math.toRadians(-90));

    private final Pose sub2Right = new Pose(65,96,Math.toRadians(-90));
