...
public class GeneratedPath {
  ...
  public static PathChain line1 = builder
          .addPath(
                  new BezierLine(
                          new Point(10.000, 66.000, Point.CARTESIAN),
  ...
  public static PathChain line2 = builder
          .addPath(
                  new BezierCurve(
                          new Point(40.000, 66.000, Point.CARTESIAN),
                          new Point(1.000, 25.000, Point.CARTESIAN),
                          new Point(65.000, 45.000, Point.CARTESIAN),
  ...
  public static PathChain line9 = builder
          .addPath(
                  new BezierLine(
                          new Point(14.000, 30.000, Point.CARTESIAN),
                          new Point(11.000, 30.000, Point.CARTESIAN)
                  )
          )
          .setConstantHeadingInterpolation(Math.toRadians(0))
          .build();
